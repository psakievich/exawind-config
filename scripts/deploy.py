...
def setup(args):
    ...
    template = os.path.expandvars("$SPACK_MANAGER/templates/exawind_{}.yaml".format(machine))

    if not os.path.isfile(template):
        template = os.path.expandvars("$SPACK_MANAGER/templates/exawind_basic.yaml")
